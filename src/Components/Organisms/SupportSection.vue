  ...
  <div class="relative isolate overflow-hidden bg-quicksilver-900 py-12 my-12 sm:py-20 sm:my-20 font-poppins">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-3xl font-bold tracking-tight text-snowwhite  sm:text-4xl">Support center</h2>
        <p class="mt-6 text-lg leading-8 text-quicksilver-300">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
      </div>
      <!-- Support card grid -->
      <SupportCardGrid :cards="cards" />
    </div>
...
import SupportCardGrid from '@/Components/Molecules/SupportCardGrid.vue';
